 ...
 <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-12 text-center rounded-pill" style="background-color: yellow; height: 130px; margin-top:90px;">
            <h1 style="font-weight: bolder; color:black; font-size: calc(1.9rem + 1vw); margin-top: calc(1rem + 1vw);">Instagram</h1>
          </div>
        </div>
       </div>
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" style="margin-top: calc(4rem + 1vw);">
            ...
            <h1 class="">Instagram Marketing And Management Packages</h1>
            <h2 class="">Instagram Ads Cost & Marketing Plans</h2>
